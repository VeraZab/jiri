...
export default function FilmProjects() {
    return (
        <PortfolioPageLayout>
            <PortfolioGrid>
                <PortfolioImage src="/images/shangshi.webp" alt="shang-chi: the legend of the ten rings - movie poster" />
                <PortfolioImage src="/images/weeknd.jpg" alt="spotify x the weeknd - alone with me interractive experience" />
